...
function navGroups(user, active, features = {}, modelNav = null) {
  ...
  if (user.role === "finance_admin") groups.push({ label: "Admin", items: [I("/accounts", "Collaborators", "accounts"), I("/integrations/google", "Google Sheets", "google"), I("/audit", "Audit", "audit")] });
  return groups;
}
